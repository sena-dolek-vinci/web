...
//import './App.css'
// on enleve le css et on rajoute les composant du MUI 
...
const App = () => {  
  ...
  // on remplace div par box 
  // utilisatiuon de sx pour donnner directement un style 
  // remplacement de p par Typography et garde le style visuel d'un h1 grace a variant="h1"
  // typography = composnat mui qui sert a ecrire et afficher du texte 
  // remplacement de main par box 
  // le className pour le css a ete remplace par sx 
  // le component="main" dit je veux que ce composant MUI soit affiche comme une balise <main>
  // html dans la page 
  return (
